...
if (!empty($pass)) {
    ...
    $query = "UPDATE users SET full_name='$nombres', password='$hashed_pass', email='$correo', membership='$membresia', otp='$pass' WHERE id='$iduser'";
} else {
  
    $query = "UPDATE users SET full_name='$nombres', email='$correo', membership='$correo' WHERE id='$iduser'";
}
