        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Medida pechos</h1>
                        <div class="">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Ajustes</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Medida pechos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-task">
                            <i class="bx bx-user-plus align-middle"></i> Agregar Campo
                        </button>
                    ...
                    <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action='procesar8.php' method='post' enctype='multipart/form-data' accept-charset='UTF-8'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Agregar Campo</h6>
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                       ...
                                                       <div class="col-xl-12">
                                                            ...
                                                            <select class="form-control" data-trigger name="clave" id="choices-single-default" required>
                                                                
                                                                <option value="8" selected>Medida pechos (cm)</option>
                                                            </select>
                                                        </div>
                                                        
                                                        <div class="col-xl-12">
                                                            <label for="task-name" class="form-label">Valor</label>
                                                            <input type="text" class="form-control" id="task-name" name="valor" placeholder="" required>
                                                        </div>
                                                        <div class="col-xl-12">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap w-100">
                                    ...
                                    <tbody>
                                <?php
                            		$query = "SELECT * FROM detalles WHERE clave = '8'";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $visible = $row["visible"];
                                        $titulo="";
                                        if($visible==1){$visible="Si";}else{$visible="No";}
                                        if($clave=="1"){$titulo="Edad";$selected1="selected";}
                                        if($clave=="2"){$titulo="Sexo";$selected2="selected";}
                                        if($clave=="3"){$titulo="Color Cabello";$selected3="selected";}
                                        if($clave=="4"){$titulo="Tipo Piel";$selected4="selected";}
                                        if($clave=="5"){$titulo="Complexion";$selected5="selected";}
                                        if($clave=="6"){$titulo="Peso Kg";$selected6="selected";}
                                        if($clave=="7"){$titulo="Altura (m)";$selected7="selected";}
                                        if($clave=="8"){$titulo="Medida pechos (cm)";$selected8="selected";}
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action="procesar8i.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                            <input type="hidden" class="form-control" id="task-name" name="idus" placeholder="" value="'.$idus.'" required>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Editar Campo</h6>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        <div class="col-xl-12">
                                                            <label for="choices-single-default" class="form-label">Clave</label>
                                                            <select class="form-control" data-trigger name="clave" id="choices-single-default">
                                                              
                                                                <option value="8" '.$selected8.'>Medida pechos (cm)</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Valor</label>
                                                            <input type="text" class="form-control" id="task-id" name="valor" placeholder="" value="'.$descripcion.'" required>
                                                        </div>
...
<script>
    function confirmDelete(idCliente) {
        ...
        if (confirmation) {
            ...
            window.location.href = "procesar8j.php?idus=" + encodeURIComponent(idCliente);
