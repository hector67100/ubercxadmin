<!DOCTYPE html>
<html lang="en" dir="ltr" data-nav-layout="vertical" data-vertical-style="overlay" data-theme-mode="light" data-header-styles="light" data-menu-styles="color" data-toggled="close">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="img/iconBannerMain.png" type="image/x-icon">
...
<body class="authentication-background authenticationcover-background position-relative" id="particles-js" style="background: black;">
    ...
    <div class="container">
        <div class="row justify-content-center authentication authentication-basic align-items-center h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                ...
                <form novalidate="novalidate" id="kt_sign_in_form" action="login.php" method="POST">
                <div class="card custom-card my-4 border z-3 position-relative" style="background-color: red;">
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="d-flex align-items-center justify-content-center mb-3">
                                <span class="auth-icon">
                                   <img src="img/iconBannerMain.png" alt="logo" style="width: 100px;height: 100px;" class="desktop-dark"> 
                                </span>
                             </div>
                            <p class="h4 fw-semibold mb-0 text-center" style="color: white !important;">Inicio sesión</p>
                            <br>
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    <label for="signup-firstname" class="form-label text-default" style="color: white !important;">Correo</label>
                                      <div class="position-relative">
                                        <input type="email" name="email" class="form-control form-control-lg" id="signup-firstname"
                                            placeholder="Ingresar email">
                                    </div>
                                </div>
                                <div class="col-xl-12 mb-2">
                                    <label for="signin-password" class="form-label text-default d-block" style="color: white !important;">Contraseña</label>
                                    <div class="position-relative">
                                        <input type="password" name="password" class="form-control form-control-lg" id="signin-password" placeholder="Ingresar contraseña">
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" id="kt_sign_in_submit" class="btn btn-dark">Acceder</button>
                            </div>
