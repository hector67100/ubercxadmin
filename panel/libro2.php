...
require('php_lib/include-pagina-restringida.php'); //el incude para vericar que estoy logeado. Si falla salta a la pÃÂ¡gina de login.php
	...
	?>
<!DOCTYPE html>
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="ligth" data-header-styles="ligth" data-width="fullwidth" data-menu-styles="ligth" data-toggled="close" style="--primary-rgb: 244, 0, 0;">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="img/ebook-logo.svg" type="image/x-icon">
...
<body>
     ...
     <!-- Loader -->
<div id="loader" >
    <img src="img/ebook-logo.svg" alt="">
</div>
<!-- Loader -->
            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="dashboard.php" class="header-logo">
                        <img src="img/ebook-logo.svg" alt="logo" class="desktop-logo">
                        <img src="img/ebook-logo.svg" alt="logo" class="toggle-logo">
                        <img src="img/ebook-logo.svg" alt="logo" class="desktop-dark">
                        <img src="img/ebook-logo.svg" alt="logo" class="toggle-dark">
                    </a>
                </div>
            </div>
            <!-- End::header-element -->
...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="dashboard.php" class="header-logo" style="display: flex;">
            ...
            <img src="img/ebook-logo.svg" alt="logo" class="desktop-dark">
            <img src="img/ebook-logo.svg" alt="logo" class="toggle-logo">
            <p style="margin-bottom: 0;font-size: large;margin-left: 7px;">Ebook</p>
        </a>
    </div>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Libros</h1>
                        <div class="">
                            <nav>
                    ...
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-product">
                            <i class="bx bx-category align-middle"></i> Agregar Libros
                        </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4">
                    <div class="row gy-2">
                        ...
                        <div class="col-xl-12">
                            <label for="upload_data" class="form-label">Fecha de Subida</label>
                            <input type="text" class="form-control" id="upload_data" name="upload_data">
                        </div>
                        <div class="col-xl-12">
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-12">
                                                            ...
                                                            <input type="number" class="form-control" name="category_id" value="'.$category_id.'" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="tag_id" class="form-label">Etiqueta ID</label>
                                                            <input type="text" class="form-control" name="tag_id" value="'.$tag_id.'" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="name" class="form-label">Nombre</label>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="audio_link" class="form-label">Enlace de Audio</label>
                                                            <input type="text" class="form-control" name="audio_link" value="'.$audio_link.'" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="description" class="form-label">Descripción</label>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="upload_data" class="form-label">Fecha de Carga</label>
                                                            <input type="text" class="form-control" name="upload_data" value="'.$upload_data.'" required>
                                                        </div>
                                                        <div class="col-xl-12">
...
<script>
    function confirmDelete(idProducto) {
        const message = `¿Desea eliminar el libro con ID: ${idProducto}?`;
