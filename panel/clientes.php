                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-task">
                            <i class="bx bx-user-plus align-middle"></i> Agregar Cliente
                        </button>
                    ...
                    <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action='procesar3.php' method='post' enctype='multipart/form-data' accept-charset='UTF-8'>
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action="procesar3i.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
...
<script>
    function confirmDelete(idCliente) {
        const message = `¿Desea eliminar el registro del cliente con ID: ${idCliente}?`;
        const confirmation = confirm(message);
        
        if (confirmation) {
            // Aquí puedes agregar la lógica para eliminar el registro del cliente
            console.log(`Registro del cliente con ID ${idCliente} eliminado.`); // Ejemplo
            window.location.href = "procesar3j.php?idus=" + encodeURIComponent(idCliente);
