...
if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
    ...
    if (in_array($fotoType, $allowedMimeTypes)) {
        ...
        // Generar un nombre «ânico para la imagen para evitar conflictos
        ...
        if (move_uploaded_file($fotoTmpPath, $uploadFilePath)) {
            ...
            $query = "INSERT INTO categories (name, description, status, image) VALUES ('$nombres', '$descripcion', '$visible', '$fileName')";
    ...
    $query = "INSERT INTO categories (name, description, status) VALUES ('$nombres', '$descripcion', '$visible')";
    mysqli_query($link, $query) or die(mysqli_error($link));
}
