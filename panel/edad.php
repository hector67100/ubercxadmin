        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Edad</h1>
                        <div class="">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Ajustes</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edad</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap w-100">
                                    ...
                                    <tbody>
                                <?php
                            		$query = "SELECT * FROM detalles WHERE clave = '1'";
                                                    ...
                                                    <div class="row gy-2">
                                                        <div class="col-xl-12">
                                                            ...
                                                            <select class="form-control" data-trigger name="clave" id="choices-single-default">
                                                                <option value="1" '.$selected1.'>Edad</option>
