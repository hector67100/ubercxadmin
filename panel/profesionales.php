        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Profesionales</h1>
                        <div class="">
                            <nav>
                    ...
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-task">
                            <i class="bx bx-user-plus align-middle"></i> Agregar Profesional
                        </button>
                    ...
                    <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action='procesar9.php' method='post' enctype='multipart/form-data' accept-charset='UTF-8'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Agregar Profesional</h6>
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        <div class="col-xl-12">
                                                            <label for="task-name" class="form-label">Nombres</label>
                                                        ...
                                                        <div class="col-xl-12">
                                                            ...
                                                            <input type="email" class="form-control" id="task-id" name="correo" placeholder="" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Contraseña</label>
                                                            <input type="text" class="form-control" id="task-id" name="pass" placeholder="" required>
                                                        </div>
                                                       <div class="col-xl-12" style="display: none">
                                                            <label class="form-label">Membresia</label>
                                                            <select class="form-control" data-trigger name="choices-single-default" name="membresia" id="choices-single-default">
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action="procesar9i.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                            <input type="hidden" class="form-control" id="task-name" name="idus" placeholder="" value="'.$idus.'" required>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Editar Profesional</h6>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Email</label>
                                                            <input type="email" class="form-control" id="task-id" name="correo" placeholder="" value="'.$email.'" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Contraseña</label>
                                                            <input type="text" class="form-control" id="task-id" name="pass" placeholder="Vacio si no desea cambiar la contraseña" value="" required>
                                                        </div>
                                                       <div class="col-xl-12" style="display: none">
                                                            <label class="form-label">Membresia</label>
                                                            <select class="form-control" data-trigger name="choices-single-default" name="membresia" id="choices-single-default">
...
<script>
    function confirmDelete(idCliente) {
        const message = `¿Desea eliminar el registro del profesional con ID: ${idCliente}?`;
        const confirmation = confirm(message);
        
        if (confirmation) {
            // Aquí puedes agregar la lógica para eliminar el registro del cliente
            console.log(`Registro del profesional con ID ${idCliente} eliminado.`); // Ejemplo
            window.location.href = "procesar9j.php?idus=" + encodeURIComponent(idCliente);
