        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Administradores</h1>
                        <div class="">
                            <nav>
                    ...
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-task">
                            <i class="bx bx-user-plus align-middle"></i> Agregar Administrador
                        </button>
                    ...
                    <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action='procesar4.php' method='post' enctype='multipart/form-data' accept-charset='UTF-8'>
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-12">
                                                            ...
                                                            <input type="password" class="form-control" id="task-id" name="pass" placeholder="" required>
                                                        </div>
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action="procesar4i.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Contraseña</label>
                                                            <input type="password" class="form-control" id="task-id" name="pass" placeholder="Vacio si no desea cambiar la contraseña" value="" required>
                                                        </div>
...
<script>
    function confirmDelete(idCliente) {
        ...
        if (confirmation) {
            ...
            window.location.href = "procesar4j.php?idus=" + encodeURIComponent(idCliente);
