        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Tarifas</h1>
                        <div class="">
                            <nav>
                    ...
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-task">
                            <i class="bx bx-category align-middle"></i> Agregar Tarifas
                        </button>
                    ...
                    <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action='procesar5.php' method='post' enctype='multipart/form-data' accept-charset='UTF-8'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Agregar Tarifas</h6>
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Descripción</label>
                                                            <input type="text" class="form-control" id="task-id" name="descripcion" placeholder="" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action="procesar5i.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                            <input type="hidden" class="form-control" id="task-name" name="idus" placeholder="" value="'.$idus.'" required>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Editar Tarifas</h6>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body px-4">
                                                    ...
                                                    if ($imageName) {
                                                        ...
                                                        $imagePath = '../../ebook/uploads/category/' . $imageName;
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Descripción</label>
                                                            <input type="text" class="form-control" id="task-id" name="descripcion" placeholder="" value="'.$email.'" required>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Visible</label>
                                                            <select class="form-control" name="visible" id="choices-single-default">';
...
<script>
    function confirmDelete(idCliente) {
        ...
        if (confirmation) {
            ...
            window.location.href = "procesar5j.php?idus=" + encodeURIComponent(idCliente);
