        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Ciudades</h1>
                        <div class="">
                            <nav>
                    ...
                    <div class="btn-list">
                        <button class="btn btn-primary-light btn-wave me-2" data-bs-toggle="modal" data-bs-target="#create-task">
                            <i class="bx bx-category align-middle"></i> Agregar Ciudades
                        </button>
                    ...
                    <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action='procesar6.php' method='post' enctype='multipart/form-data' accept-charset='UTF-8'>
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Agregar Ciudades</h6>
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="task-id" class="form-label">Provincia</label>
                                                            <select class="form-control" name="visible" id="category_id">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $imageName = $row['image'];
                                        $category_name="none";
                                        $query3 = "SELECT name FROM provincia WHERE id = '$visible'";
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form class="form" action="procesar6i.php" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
...
<script>
    function confirmDelete(idCliente) {
        const message = `¿Desea eliminar el registro de la etiqueta con ID: ${idCliente}?`;
        const confirmation = confirm(message);
        
        if (confirmation) {
            // Aquí puedes agregar la lógica para eliminar el registro del cliente
            console.log(`Registro de la etiqueta con ID ${idCliente} eliminado.`); // Ejemplo
            window.location.href = "procesar6j.php?idus=" + encodeURIComponent(idCliente);
